...
def extract_secondary_identifier(properties):
    if 'fitbit_type' in properties:
        return properties['fitbit_type']
...
#
#     context['values'] = DataPoint.objects.filter(source=source.identifier,
#      generator_identifier=generator, created__gt=start, created__lte=end).order_by('created')
#
...
#     filename = settings.MEDIA_ROOT + '/pdk_visualizations/' + source.identifier +
# '/pdk-app-event/timestamp-counts.json'
#
