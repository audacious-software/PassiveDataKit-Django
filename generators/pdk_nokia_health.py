...
#
#     context['values'] = DataPoint.objects.filter(source=source.identifier, generator_identifier=generator, created__gt=start, created__lte=end).order_by('created') # pylint: disable=no-member,line-too-long
#
...
#     filename = settings.MEDIA_ROOT + '/pdk_visualizations/' + source.identifier + '/pdk-app-event/timestamp-counts.json' # pylint: disable=no-member,line-too-long
#
